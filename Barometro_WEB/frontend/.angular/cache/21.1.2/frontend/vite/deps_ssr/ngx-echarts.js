...
var ChangeFilterV2 = class {
  constructor() {
    this.subject = new import_rxjs2.ReplaySubject(1);
...
var NgxEchartsDirective = class _NgxEchartsDirective {
  constructor() {
    ...
    this.chart$ = new import_rxjs2.ReplaySubject(1);
  ...
  ngOnInit() {
    ...
    this.resizeSub = this.resize$.pipe((0, import_operators2.throttleTime)(100, import_rxjs2.asyncScheduler, {
      leading: false,
      trailing: true
  ...
  createLazyEvent(eventName) {
    return outputToObservable(this.chartInit).pipe((0, import_operators2.switchMap)((chart) => new import_rxjs2.Observable((observer) => {
